...
export function FeaturedProperty() {
  ...
  const propertyImages = [
    ...
    { src: "/bed2.jpeg", alt: "Master bedroom with balcony and night city views" },
    { src: "/bed3.jpeg", alt: "Modern bedroom with elegant furnishings" },
    { src: "/bed4.jpeg", alt: "Spacious bedroom with contemporary design" },
    { src: "/bed5.jpeg", alt: "Luxury bathroom with modern fixtures" },
    { src: "/bed6.jpeg", alt: "Contemporary bathroom with bathtub" },
        { src: "/bed7.jpeg", alt: "Bedroom with stunning Burj Khalifa night view" },
    { src: "/bed8.jpeg", alt: "Luxury bedroom with Dubai skyline view" },
    { src: "/bed9.jpeg", alt: "Bedroom with daytime Burj Khalifa view" },
    { src: "/bed10.jpeg", alt: "Master bedroom with balcony and night city views" },
    { src: "/bed13.jpeg", alt: "Modern bedroom with elegant furnishings" },
    { src: "/kitchen.jpeg", alt: "Spacious bedroom with contemporary design" },
    { src: "/kitchen2.jpeg", alt: "Luxury bathroom with modern fixtures" },
    { src: "/oven.jpeg", alt: "Contemporary bathroom with bathtub" },
    { src: "/plates.jpeg", alt: "Luxury bathroom with modern fixtures" },
    { src: "/light.jpeg", alt: "Contemporary bathroom with bathtub" },
    { src: "/tissues.jpeg", alt: "Contemporary bathroom with bathtub" },
